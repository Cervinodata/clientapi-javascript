...
export default class AnalyticsDataDefaultMetricsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getGA4ReportPerDevicePerChannelGroupPerOrganisationPerPropertyPerDay operation.
     * @callback module:api/AnalyticsDataDefaultMetricsApi~getGA4ReportPerDevicePerChannelGroupPerOrganisationPerPropertyPerDayCallback
     * @param {String} error Error message, if any.
     * @param {String} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link String}
     */
    getGA4ReportPerDevicePerChannelGroupPerOrganisationPerPropertyPerDay(organisationUuids, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'organisationUuids' is set
      if (organisationUuids === undefined || organisationUuids === null) {
        throw new Error("Missing the required parameter 'organisationUuids' when calling getGA4ReportPerDevicePerChannelGroupPerOrganisationPerPropertyPerDay");
      }
