...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CervinodataApiClient.CreateOrganisationRequest();
  });
  ...
  describe('CreateOrganisationRequest', function() {
    it('should create an instance of CreateOrganisationRequest', function() {
      // uncomment below and update the code to test CreateOrganisationRequest
      //var instance = new CervinodataApiClient.CreateOrganisationRequest();
      //expect(instance).to.be.a(CervinodataApiClient.CreateOrganisationRequest);
    });
