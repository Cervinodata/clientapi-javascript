...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CervinodataApiClient.CampaignGroupApi();
  });
  ...
  describe('CampaignGroupApi', function() {
    describe('getCampaignGroupAnalyticsReportPerOrganisationPerDay', function() {
      it('should call getCampaignGroupAnalyticsReportPerOrganisationPerDay successfully', function(done) {
        //uncomment below and update the code to test getCampaignGroupAnalyticsReportPerOrganisationPerDay
        //instance.getCampaignGroupAnalyticsReportPerOrganisationPerDay(function(error) {
