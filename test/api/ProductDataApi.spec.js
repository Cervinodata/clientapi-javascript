...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CervinodataApiClient.ProductDataApi();
  });
  ...
  describe('ProductDataApi', function() {
    describe('getGA4ReportPerChannelGroupPerProductNamePerOrganisationPerPropertyPerMonth', function() {
      it('should call getGA4ReportPerChannelGroupPerProductNamePerOrganisationPerPropertyPerMonth successfully', function(done) {
        //uncomment below and update the code to test getGA4ReportPerChannelGroupPerProductNamePerOrganisationPerPropertyPerMonth
        //instance.getGA4ReportPerChannelGroupPerProductNamePerOrganisationPerPropertyPerMonth(function(error) {
