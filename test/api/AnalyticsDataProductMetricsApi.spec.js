...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CervinodataApiClient.AnalyticsDataProductMetricsApi();
  });
  ...
  describe('AnalyticsDataProductMetricsApi', function() {
    describe('getGA4ReportPerProductNamePerOrganisationPerPropertyPerWeek', function() {
      it('should call getGA4ReportPerProductNamePerOrganisationPerPropertyPerWeek successfully', function(done) {
        //uncomment below and update the code to test getGA4ReportPerProductNamePerOrganisationPerPropertyPerWeek
        //instance.getGA4ReportPerProductNamePerOrganisationPerPropertyPerWeek(function(error) {
    ...
    describe('getGA4ReportPerProductSkuPerOrganisationPerPropertyPerWeek', function() {
      it('should call getGA4ReportPerProductSkuPerOrganisationPerPropertyPerWeek successfully', function(done) {
        //uncomment below and update the code to test getGA4ReportPerProductSkuPerOrganisationPerPropertyPerWeek
        //instance.getGA4ReportPerProductSkuPerOrganisationPerPropertyPerWeek(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
