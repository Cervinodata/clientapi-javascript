...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CervinodataApiClient.AnalyticsDataApi();
  });
  ...
  describe('AnalyticsDataApi', function() {
    describe('getViews', function() {
      it('should call getViews successfully', function(done) {
        //uncomment below and update the code to test getViews
        //instance.getViews(function(error) {
