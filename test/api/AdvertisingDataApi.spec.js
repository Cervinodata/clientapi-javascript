...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CervinodataApiClient.AdvertisingDataApi();
  });
  ...
  describe('AdvertisingDataApi', function() {
    describe('getAdAccounts', function() {
      it('should call getAdAccounts successfully', function(done) {
        //uncomment below and update the code to test getAdAccounts
        //instance.getAdAccounts(function(error) {
    ...
    describe('getAdCampaignReportPerDay', function() {
      it('should call getAdCampaignReportPerDay successfully', function(done) {
        //uncomment below and update the code to test getAdCampaignReportPerDay
        //instance.getAdCampaignReportPerDay(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAdCampaignReportPerOrganisationPerAccountPerDay', function() {
      it('should call getAdCampaignReportPerOrganisationPerAccountPerDay successfully', function(done) {
        //uncomment below and update the code to test getAdCampaignReportPerOrganisationPerAccountPerDay
        //instance.getAdCampaignReportPerOrganisationPerAccountPerDay(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAdCampaigns', function() {
      it('should call getAdCampaigns successfully', function(done) {
        //uncomment below and update the code to test getAdCampaigns
        //instance.getAdCampaigns(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
